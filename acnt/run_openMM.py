...
Topology.loadBondDefinitions('acnt_residue.xml')
pdb = PDBFile('equil_acnt.pdb')
strdir = 'test_sim/'
...
forcefield = ForceField('acnt.xml')
modeller.addExtraParticles(forcefield)

system = forcefield.createSystem(modeller.topology, nonbondedCutoff=1.0*nanometer, constraints=None, rigidWater=False)
